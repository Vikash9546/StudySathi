...
import { StyleSheet, Text, View, ScrollView, TouchableOpacity, ActivityIndicator, FlatList, Alert, RefreshControl, Modal, Dimensions } from 'react-native';
...
export default function StudyScreen() {
  ...
  const fetchDocuments = async () => {
    try {
      const res: any = await api.get('/api/documents');
  ...
  const handleAction = (action: 'quiz' | 'flashcard' | 'tutor' | 'notes') => {
